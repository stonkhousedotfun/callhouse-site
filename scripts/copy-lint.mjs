 ...
 * rules. They fail CI.
 *
 * This repo is callhouse.xyz, the public marketing landing. It is the surface the
 ...
 * other build output are skipped. The dapp (app.callhouse.xyz) lives in
...
if (errors.length) {
  ...
  console.error("This repo is callhouse.xyz, the public landing these rules exist for. It is not exempt.");
