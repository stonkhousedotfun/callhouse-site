/**
 * X, GitHub and GitBook marks. Used in the top bar, top-right, next to "Open the app".
 * Each leaves this origin, so they are plain new-tab <a>s.
 */
import { ExternalLink } from "@/components/ui/ExternalLink";
import { GitBookIcon, GitHubIcon, XIcon } from "@/components/ui/icons";
  ...
  return (
    <nav aria-label="Stonkhouse elsewhere">
      <ul className="flex items-center gap-0.5">
        ...
        <li>
          <ExternalLink href={DOCS_URL} className={ITEM} aria-label="GitBook">
            <GitBookIcon size={16} />
          </ExternalLink>
        </li>
      </ul>
